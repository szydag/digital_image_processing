import sys
from PyQt5.QtWidgets import QApplication, QMainWindow, QMdiArea, QMdiSubWindow, QAction, QMenu, QLabel, QVBoxLayout, QWidget, QFrame, QToolBar
...
class MainWindow(QMainWindow):   
    ...
    def create_menu(self):
        # Toolbar oluştur
        toolbar = QToolBar("Dijital Görüntü İşleme")
